         ...
         Registration Awaited
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Registration Awaited</li>
              </ol>
            </nav>
          </div>
             ...
             <div class="col-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title"> Awaited Registration Details</h4>
                 
                  <div class="row">
                    <div class="table-responsive" id="printTable">
                     
                       <form action="{{route('admin.exprt_pndng_New_Vndr')}}" method="post" id="main_form">
      ...
      @endif
                 ...
                 @elseif($i%4==1)
                  ...
                  @elseif($i%4==2)
                   ...
                   <tr class="{{ $cls }}">
                    <td>{{$i++}}</td>
          <td style=" white-space: nowrap;"> {{$vendor->vendor_name}}</td>
