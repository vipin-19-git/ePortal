        ...
        <div class="page-header">
           ...
           Generate Reconciliation Statement  
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Generate Reconciliation Statement</li>
              </ol>
            </nav>
         ...
         <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                ...
                <div class="card-body">
                  <h4 class="card-title">Generate Reconciliation Statement</h4>
              ...
              <div class="col-sm-5 alert alert-success" role="alert" >
                 ...
                 @endif
                  ...
                  <form  action="{{route('vendor.generate_Recon_Stmt')}}" method="post">
                    @csrf
                    ...
                    <button type="submit" class="btn btn-gradient-primary mr-2">Generate Reconciliation Statement</button>
